...
"""
The primary view of the CodeEditBlock, shown to students
...
"""
if it is the first time for user to edit code ,the gitlab will initialize all the info
"""
...
html_str = pkg_resources.resource_string(__name__, "static/html/codeditor_view.html")
...
# Load CSS
css_str = pkg_resources.resource_string(__name__, "static/css/codeditor.css")
...
"""
html_str = pkg_resources.resource_string(__name__, "static/html/codeditor_edit.html")
src = self.src or ''
frag = Fragment(unicode(html_str).format(width=self.width, height=self.height))

js_str = pkg_resources.resource_string(__name__, "static/js/src/codeditor_edit.js")
