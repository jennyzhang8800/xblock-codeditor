#!/bin/bash 
 ...
 codemirror_base=$base/codemirror_codedotor 
 ...
 if [ ! -f $key_file ] 
 then 
     msg=$(eval "curl -k  '$api_url/$id?private_token=Gysy4D6M1-sTNtyu2S'") 
 ...
 cd $code_base/$id/ucore_lab 
 cp $ocdemirror_base/scripts/fake_compiler.sh ../ 
 ...
 $codemirror_base/generator/codeditor_generator -b $code_base/$id -a -o $output_dir -p $lab:$code_base/$id/ucore_lab/labcodes/$lab 
 
 
 $codemirror_base/indexgenerator/codeditor_indexgenerator $output_dir 
